...
\printbibliography[nottype=online,notkeyword=ai-generated,heading=bibintoc,title={\langde{Literaturverzeichnis}\langen{Bibliography}}]
...
\printbibliography[type=online,notkeyword=ai-generated,heading=subbibliography,title={\headingNameInternetSources}]

% KI-generierte Quellen als eigene Untersektion des Literaturverzeichnisses
% Laut FOM Leitfaden müssen KI-generierte Inhalte transparent dokumentiert werden
\newpage
\printbibliography[keyword=ai-generated,heading=subbibliography,title={\langde{KI-generierte Quellen}\langen{AI-generated Sources}}]

% Anhang mit KI-Prompts Dokumentation
\input{kapitel/anhang/ki_prompts}

% Anhang mit Code-Listings
\input{kapitel/anhang/code_listings}
