...
% Fallback-Style, falls biblatex-Stile fehlen
...
\ifthenelse{\equal{\citationstyle}{ieee}}{
    ...
    % Falls ieee.bbx/ieee.cbx fehlen, auf numeric zurückfallen.
    \IfFileExists{ieee.bbx}{%
        \IfFileExists{ieee.cbx}{%
            \def\biblatexstyle{ieee}%
        }{%
            \def\biblatexstyle{\biblatexfallbackstyle}%
        }%
    }{%
        \def\biblatexstyle{\biblatexfallbackstyle}%
    }%
...
% Einbinden von PDFs (für den KI Anhang)
\usepackage{pdfpages}

%Prüfen ob die Aussrichtung aller inhalte einheitlich im Format des Dokumentes ist (die nächsten 2 Zeilen auskommentieren)
...
% KI-Verzeichnis
\newpage
%\input{kapitel/anhang/ki_promts}
...
\addtocontents{toc}{\protect\setcounter{tocdepth}{0}} %
  ...
  %\input{kapitel/anhang/code_listings.tex}
\end{appendices}
\addtocontents{toc}{\protect\setcounter{tocdepth}{2}}

\input{kapitel/anhang/ki_disclaimer}
