...
\begin{itemize}
	\item  \kicite{KI_Claude_2025_Taxonomie}{Anthropic}{2025}
\end{itemize}

\paragraph{Struktur für KI-Einträge in der Bibliographie :}
\begin{lstlisting}[language=TeX]
@misc{KI_Model_Jahr_Beschreibung,
    usera = {KI-generierte Inhalte},
    author = {{Modellname und Version}},
    title = {Genaue Aufgabenbeschreibung},
    year = {Jahr},
    month = {Monat},
    howpublished = {\url{plattform-url}},
    note = {Generiert am TT.MM.JJJJ},
    addendum = {Modellname und Version},
