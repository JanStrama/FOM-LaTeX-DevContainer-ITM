...
\subsubsection{KI-generierte Quellen}
Gemäß den FOM-Richtlinien müssen KI-generierte Inhalte transparent dokumentiert werden. Die Zitierung erfolgt über das Schlüsselwort \texttt{ai-generated} und wird in einem separaten Verzeichnis ausgegeben.
...
\begin{itemize}
    \item Jede KI-Nutzung muss im Literaturverzeichnis erfasst werden
    \item Das verwendete Modell und die Version sind anzugeben
    \item Der genaue Prompt oder die Aufgabenbeschreibung ist in einem Anhang zu dokumentieren.
    \item Die Dokumentation erfolgt nach Leitfaden mit Screenshots, sowohl des Prompts als auch des Resultates. Dies kann aber in absprache mit dem Betreuer auch anders defniniert werden
...
Die Erstellung der tabellarischen Taxonomie-Übersicht für die Literaturrecherche erfolgte durch Anthropic Claude 4 Sonnet\footcite[Vgl.][]{KI_Claude_2025_Taxonomie}. Dieser Eintrag wird im separaten Verzeichnis \enquote{KI-generierte Quellen} aufgeführt und nicht im regulären Literaturverzeichnis.
